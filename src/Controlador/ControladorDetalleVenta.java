...
public class ControladorDetalleVenta {
    ...
    public void actualizarDetalleVenta(int idDetalleVenta, int idVenta, int idProducto, int cantidad, float precioUnitario) {
        try {
            DetalleVenta detalle = new DetalleVenta();
            detalle.setDetalleVenta(idDetalleVenta);
            detalle.setIdVenta(idVenta);
            detalle.setIdProducto(idProducto);
            detalle.setCantidad(cantidad);
            detalle.setPrecioUnitario(precioUnitario);
    ...
    public static void main(String[] args) {
        ControladorDetalleVenta controlador = new Controlador. ControladorDetalleVenta();
        ...
        if (detalles != null) {
            ...
            for (DetalleVenta d : detalles) {
                System.out.println("ID: " + d.getDetalleVenta()
                        + ", Venta: " + d.getIdVenta()
